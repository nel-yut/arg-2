...
よって、本件は施設機能の転換と記録体系の断絶を同時に進めた制度再編の痕跡資料であり、その公開可能な外形は「第3教育寮年次報告2016」においてのみ確認できる。
`,
    pageType: "資料室",
    siteType: "archive",
    overview: "検索ワードによる",
...
「適性」の語が応答の揺れの少なさ、管理負担の軽さと並行して扱われており、2015年段階で既に第3教育寮は対象を反応特性ごとに分類し次段階へ接続するための中継区画へ変質しつつあった。
...
よって、本件は2014年以前の緩やかな教育報告と露骨な管理報告との間に位置する移行期資料であり、再編後の集約版として「第3教育寮年次報告2016」へ接続するものとして扱うことが適当である。
`,
    pageType: "資料室",
    siteType: "archive",
    overview: "検索ワードによる",
