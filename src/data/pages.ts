...
最後に澄から受け取ったのは、LINEのスクリーンショット画像だった。澄が誰かに送ったやり取りを切り取ったもので、そこに「第3教育寮」という文字が写っていた。何のことか分からなくて検索したけど何も出てこない。あの宗教のサイトを確認しようとしたら、前と内容が変わっているような気がして、ますます不安になった。
